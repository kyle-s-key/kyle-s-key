...
I am currently looking for an IT help desk or a SOC role, with a goal of eventually moving into GRC. I have a Cybersecurity BAS degree, a Philosophy BA, and CompTIA Security+, Network+, and A+ certifications. I am studying for the CySA+ exam in my spare time.
...
### 🛡️ [SOC Home Lab: Wazuh, Suricata & GNS3 Network](https://github.com/kyle-s-key/HomeLab)
...
### 🔍 [DFIR Case Study: CryptoLocker Ransomware Investigation](https://github.com/kyle-s-key/DFIR-Ransomware-Investigation)
...
### 🔍 [DFIR Case Study: Reverse Shell & Lateral Movement](https://github.com/kyle-s-key/DFIR-Reverse-Shell-Analysis)
...
<!--
**kyle-s-key/kyle-s-key** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
